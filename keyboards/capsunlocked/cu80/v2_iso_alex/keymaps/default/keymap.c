...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_tkl_iso(
     _______,_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_COMM,   KC_P0,           KC_P7,    KC_P8,    KC_P9,
    ...
    _______, KC_COMM, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_ENT,
